...
private["_text1","_text2","_text3","_text4","_text5"];
	_text1 = parseText format["%1","<t color='#D7DF01'>Willkommen</t><br /><t shadow='true'>Schön dass du auf unserem Server gekommen bist!</t><br />"];

_text2 = parseText format["%1","<t color='#0c00ff'>Spaß</t><br /><t shadow='true'>Der Spaß steht im Vordergrund aber denkt dabei ans Roleplay.</t><br />"];
...
_text5 = parseText format["%1","<t color='#ff0000'>Server</t><br /> <t color='#ff4444'>Bei Problemen, Bugs und Vorschläge dürft ihr euch gerne im TS3 Melden.<br />IP: 88.198.23.143</t>"];
