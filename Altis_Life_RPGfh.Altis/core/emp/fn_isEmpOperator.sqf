...
if((_vehicle != player) && (playerSide == west)) then {
    if((typeof _vehicle == "B_Heli_Light_01_F","I_Heli_light_03_unarmed_F","O_Heli_Light_02_unarmed_F","B_Heli_Transport_01_F") && (_vehicle getVariable ["nano_emp_enabled", false])) then {
