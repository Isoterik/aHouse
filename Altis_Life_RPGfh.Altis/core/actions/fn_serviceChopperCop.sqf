...
_search = nearestObjects[getPos air_sp_3, ["Air"],5];
...
if(!alive (_search select 0) || (_search select 0) distance air_sp_3 > 10) exitWith {life_action_inUse = false; hint localize "STR_Service_Chopper_Missing"};
