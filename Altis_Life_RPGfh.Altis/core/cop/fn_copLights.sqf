...
_lightfrontleft setLightAttenuation [0.2, 0, 40000, 0];
_lightfrontleft setLightFlareSize 0.38;
_lightfrontleft setLightFlareMaxDistance 1600;
...
_lightfrontright setLightAttenuation [0.2, 0, 40000, 0];
_lightfrontright setLightFlareSize 0.38;
_lightfrontright setLightFlareMaxDistance 1600;
...
_lightbackleft setLightAttenuation [0.2, 0, 40000, 0];
_lightbackleft setLightFlareSize 0.38;
_lightbackleft setLightFlareMaxDistance 1600;
...
_lightbackright setLightAttenuation [0.2, 0, 40000, 0];
_lightbackright setLightFlareSize 0.38;
_lightbackright setLightFlareMaxDistance 1600;
...
{  
	...
	{  
                ...
                _lightfrontleft setLightBrightness 8;
                _lightbackleft setLightBrightness 8;
				sleep 0.2;
	}  
		else  
	{  
                ...
                _lightfrontright setLightBrightness 8;
                _lightbackright setLightBrightness 8;
				sleep 0.2;
	};  
};  
