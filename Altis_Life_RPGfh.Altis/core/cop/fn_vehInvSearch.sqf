...
if (_value > 0 && (!_isHidden)) then
{
	...
	hint parseText format["<t color='#FF0000'><t size='2'>Durchsuchungsergebnis</t></t><br/><t color='#FFD700'><t size='1.5'>Besitzer</t></t><br/> %1<br/><t color='#FFD700'><t size='1.5'>Drogenwert</t></t><br/> $%2",_ownerName,_value];	sleep 1;
