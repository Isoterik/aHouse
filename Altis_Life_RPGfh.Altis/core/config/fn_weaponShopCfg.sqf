			...
			default
			{
				["Bundespolizei",
					[
						...
						["HandGrenade_Stone","Flashbang",25],
						["acc_flashlight",nil,50],
						["optic_Aco_smg",nil,100],
						["optic_Arco",nil,150],
			...
			default
			{
				["Mohammed's Jihadi Shop",
					[
						...
						["30Rnd_65x39_caseless_green",nil,2250],
			...
			default
			{
				["Harry's Feuerwaffen",
					[
						...
						["16Rnd_9x21_Mag",nil,100 * _localDonatorDiscount],
						["hgun_Pistol_heavy_02_F",nil,5000 * _localDonatorDiscount],
						["6Rnd_45ACP_Cylinder",nil,200 * _localDonatorDiscount],
						["hgun_ACPC2_F",nil,7500 * _localDonatorDiscount],
						["9Rnd_45ACP_Mag",nil,300 * _localDonatorDiscount],
						["hgun_PDW2000_F",nil,17500 * _localDonatorDiscount],
						["30Rnd_9x21_Mag",nil,700 * _localDonatorDiscount],
