...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["textures\vehicles\cop\sek_offroad.paa","cop"],
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\vehicles\cop\sek_suv.paa","cop"],
	...
	case "O_Heli_Light_02_unarmed_F":
	{
		...
		[
			...
			["textures\vehicles\cop\sek_orca.paa","cop"]
		];
	};
	...
	*/
	...
	case "I_MRAP_03_F":
	{
		...
		[
			...
			["textures\vehicles\cop\sek_strider1.paa","cop","textures\vehicles\cop\sek_strider2.paa"]
		];
	};
	case "B_Heli_Transport_01_F":
	{
		_ret = 
		[
			["textures\vehicles\cop\sek_ghost1.paa","cop","textures\vehicles\cop\sek_ghost2.paa"]
		];
	};
	...
	case "I_Heli_light_03_unarmed_F":
	{
		_ret = 
		[
			["textures\vehicles\cop\bund_hellcat.paa","cop"]
		];
	};
};
